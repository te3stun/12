...
mv -f /tmp/12-main/pppoe/ppp/pap-secrets /etc/ppp
mv -f /tmp/12-main/pppoe/ppp/chap-secrets /etc/ppp
mv -f /tmp/12-main/pppoe/ppp/pppoe-server-options /etc/ppp
mv -f /tmp/12-main/pppoe/init.d/pppoe-server /etc/init.d
mv -f /tmp/12-main/pppoe/config/pppoe /etc/config
mv -f /tmp/12-main/www/pppwn /www
mv -f /tmp/12-main/www/pppwn.html /www
mv -f /tmp/12-main/www/cgi-bin/pw.cgi /www/cgi-bin
mv -f /tmp/12-main/version /root/
mv -f /tmp/12-main/pw.conf /root/
mv -f /tmp/12-main/stage1 /root/
mv -f /tmp/12-main/stage2 /root/
mv -f /tmp/12-main/run.sh /root/

if [ -d /tmp/12-main ]; then
    rm -r /tmp/12-main
fi
