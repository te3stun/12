...
var appView = Backbone.View.extend({
    ...
    events: {
        'click button#action_pw': function(event){
            ...
            if(task == 'start'){
                ...
                button.prop('task', 'stop').removeClass('active').text('إيقاف');
            ...
            this.model.fetch({
                ...
                button.prop('task', 'start').addClass('active').text('نشيط');
        ...
        'click button#switch_pw': function(event){
            ...
            if(task == 'disable'){
                button.prop('task', 'enable').text('تمكين التشغيل التلقائي');
            }else
            if(task == 'enable'){
                ...
                button.prop('task', 'disable').text('تعطيل التشغيل التلقائي');
        ...
        'click button#pppoe_pw': function(){
            ...
            this.model.fetch({
                ...
                if(status == 'running'){
                    self.inputConnect.text('PPPoe إيقاف').val()
                }else
                if(status == 'inactive'){
                    self.inputConnect.text('PPPoe تشغيل').val(status)
                }
    ...
    render: function(response){
        ...
        if(this.model.get('running')){
            this.buttonAction.prop('task', 'stop').text('إيقاف');
        }else{
            this.buttonAction.prop('task', 'start').text('تشغيل');
        }

        if(this.model.get('autorun')){
            this.buttonSwitch.prop('task', 'disable').text('تعطيل التشغيل التلقائي');
        }else{
            this.buttonSwitch.prop('task', 'enable').text('تمكين التشغيل التلقائي');
        }
